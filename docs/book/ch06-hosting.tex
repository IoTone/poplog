...
Sooner or later the fleet wants its own language --- a terse orders notation
the agent can emit and a robot can read --- and Chapter~5's front-ends are
not privileged. The API they target is public, and
