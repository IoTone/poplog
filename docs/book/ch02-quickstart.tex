...
\item \textbf{MCP} (\code{tools/pop11-mcp}): the same idea for agents. A
  persistent, natively compiled session exposed as four tools ---
  \code{pop11\_eval}, \code{pop11\_help}, \code{pop11\_checkpoint},
  \code{pop11\_state}.
\end{itemize}
