...
Poplog has had a foreign-function interface since 1987, and it is unusually
deep: external code is loaded into the \emph{running} image by Poplog's own
...
: crypto_hmac_hex('sha256', 'key', 'message') =>
** 6e9ef29b75fffc5b7abae527d58fdadb2fe42e7219011976917343065f58ed4a
: length(crypto_random(16)) =>
** 16
: crypto_version() =>
